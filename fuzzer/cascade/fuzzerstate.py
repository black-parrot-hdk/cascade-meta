    ...
    def gen_pick_weights(self):
        ...
        if self.isa_class_p_distr is not None:
            self.isapickweights = {
                ...
                ISAInstrClass.MEMFPUD:     (self.isa_class_p_distr[5]),
                ISAInstrClass.FPU:         (self.isa_class_p_distr[6]),
                ISAInstrClass.FPUD:        (self.isa_class_p_distr[6]),
                ISAInstrClass.FPU64:       (self.isa_class_p_distr[7]),
                ISAInstrClass.FPUD64:      (self.isa_class_p_distr[7]),
                ISAInstrClass.MEDELEG:     (0),
                ISAInstrClass.TVECFSM:     (0),
                ISAInstrClass.PPFSM:       (0),
                ISAInstrClass.EPCFSM:      (0),
                ISAInstrClass.EXCEPTION:   (0),
                ISAInstrClass.RANDOM_CSR:  (self.isa_class_p_distr[8]),
