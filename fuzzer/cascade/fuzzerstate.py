...
class FuzzerState:
    ...
    def gen_pick_weights(self):
        ...
        if self.isa_class_p_distr is None:
            subrandom = random.Random(0xfacade)
            self.isapickweights = {
                # will be normalized again later
                ISAInstrClass.REGFSM:      (subrandom.random() + 0.05 ) * ISAINSTRCLASS_INITIAL_BOOSTERS[ISAInstrClass.REGFSM],
                ISAInstrClass.FPUFSM:      (subrandom.random() + 0.05 ) * ISAINSTRCLASS_INITIAL_BOOSTERS[ISAInstrClass.FPUFSM],
                ISAInstrClass.ALU:         (self.isa_class_p_distr[0] ) * ISAINSTRCLASS_INITIAL_BOOSTERS[ISAInstrClass.ALU],
                ISAInstrClass.ALU64:       (self.isa_class_p_distr[1] ) * ISAINSTRCLASS_INITIAL_BOOSTERS[ISAInstrClass.ALU64],
                ISAInstrClass.MULDIV:      (self.isa_class_p_distr[2] ) * ISAINSTRCLASS_INITIAL_BOOSTERS[ISAInstrClass.MULDIV],
                ISAInstrClass.MULDIV64:    (self.isa_class_p_distr[3] ) * ISAINSTRCLASS_INITIAL_BOOSTERS[ISAInstrClass.MULDIV64],
                ISAInstrClass.AMO:         (self.isa_class_p_distr[4] ) * ISAINSTRCLASS_INITIAL_BOOSTERS[ISAInstrClass.AMO],
                ISAInstrClass.AMO64:       (self.isa_class_p_distr[5] ) * ISAINSTRCLASS_INITIAL_BOOSTERS[ISAInstrClass.AMO64],
                ISAInstrClass.JAL :        (subrandom.random() + 0.05 ) * ISAINSTRCLASS_INITIAL_BOOSTERS[ISAInstrClass.JAL],
                ISAInstrClass.JALR:        (subrandom.random() + 0.05 ) * ISAINSTRCLASS_INITIAL_BOOSTERS[ISAInstrClass.JALR],
                ISAInstrClass.BRANCH:      (subrandom.random() + 0.05 ) * ISAINSTRCLASS_INITIAL_BOOSTERS[ISAInstrClass.BRANCH],
                ISAInstrClass.MEM:         (self.isa_class_p_distr[6]) * ISAINSTRCLASS_INITIAL_BOOSTERS[ISAInstrClass.MEM],
                ISAInstrClass.MEM64:       (self.isa_class_p_distr[7]) * ISAINSTRCLASS_INITIAL_BOOSTERS[ISAInstrClass.MEM64],
                ISAInstrClass.MEMFPU:      (self.isa_class_p_distr[8]) * ISAINSTRCLASS_INITIAL_BOOSTERS[ISAInstrClass.MEMFPU]  * self.fpuweight,
                ISAInstrClass.FPU:         (self.isa_class_p_distr[9]) * ISAINSTRCLASS_INITIAL_BOOSTERS[ISAInstrClass.FPU]     * self.fpuweight,
                ISAInstrClass.FPU64:       (self.isa_class_p_distr[10]) * ISAINSTRCLASS_INITIAL_BOOSTERS[ISAInstrClass.FPU64]   * self.fpuweight,
                ISAInstrClass.MEMFPUD:     (self.isa_class_p_distr[11]) * ISAINSTRCLASS_INITIAL_BOOSTERS[ISAInstrClass.MEMFPUD] * self.fpuweight,
                ISAInstrClass.FPUD:        (self.isa_class_p_distr[12]) * ISAINSTRCLASS_INITIAL_BOOSTERS[ISAInstrClass.FPUD]    * self.fpuweight,
                ISAInstrClass.FPUD64:      (self.isa_class_p_distr[13]) * ISAINSTRCLASS_INITIAL_BOOSTERS[ISAInstrClass.FPUD64]  * self.fpuweight,
                ISAInstrClass.MEDELEG:     (subrandom.random() + 0.05 ) * ISAINSTRCLASS_INITIAL_BOOSTERS[ISAInstrClass.MEDELEG],
                ISAInstrClass.TVECFSM:     (subrandom.random() + 0.05 ) * ISAINSTRCLASS_INITIAL_BOOSTERS[ISAInstrClass.TVECFSM],
                ISAInstrClass.PPFSM:       (subrandom.random() + 0.05 ) * ISAINSTRCLASS_INITIAL_BOOSTERS[ISAInstrClass.PPFSM],
                ISAInstrClass.EPCFSM:      (subrandom.random() + 0.05 ) * ISAINSTRCLASS_INITIAL_BOOSTERS[ISAInstrClass.EPCFSM],
                ISAInstrClass.EXCEPTION:   (subrandom.random() + 0.05 ) * ISAINSTRCLASS_INITIAL_BOOSTERS[ISAInstrClass.EXCEPTION],
                ISAInstrClass.RANDOM_CSR:  (subrandom.random() + 0.05 ) * ISAINSTRCLASS_INITIAL_BOOSTERS[ISAInstrClass.RANDOM_CSR],
                ISAInstrClass.DESCEND_PRV: (subrandom.random() + 0.05 ) * ISAINSTRCLASS_INITIAL_BOOSTERS[ISAInstrClass.DESCEND_PRV],
                ISAInstrClass.SPECIAL:     (subrandom.random() + 0.05 ) * ISAINSTRCLASS_INITIAL_BOOSTERS[ISAInstrClass.SPECIAL],
            }
        else:
            self.isapickweights = {
