    ...
    def gen_pick_weights(self):
        ...
        if self.isa_class_p_distr is not None:
            self.isapickweights = {
                ...
                ISAInstrClass.ALU:         (self.isa_class_p_distr[0]),
                ISAInstrClass.ALU64:       (self.isa_class_p_distr[0]),
                ISAInstrClass.MULDIV:      (self.isa_class_p_distr[1]),
                ISAInstrClass.MULDIV64:    (self.isa_class_p_distr[1]),
                ISAInstrClass.AMO:         (0),
                ISAInstrClass.AMO64:       (0),
                ISAInstrClass.JAL :        (self.isa_class_p_distr[2] + 0.005),
                ISAInstrClass.JALR:        (self.isa_class_p_distr[2] + 0.005),
                ISAInstrClass.BRANCH:      (self.isa_class_p_distr[2] + 0.005),
                ISAInstrClass.MEM:         (self.isa_class_p_distr[3]),
                ISAInstrClass.MEM64:       (self.isa_class_p_distr[3]),
                ISAInstrClass.MEMFPU:      (self.isa_class_p_distr[4]),
                ISAInstrClass.MEMFPUD:     (self.isa_class_p_distr[4]),
                ISAInstrClass.FPU:         (self.isa_class_p_distr[5]),
                ISAInstrClass.FPUD:        (self.isa_class_p_distr[5]),
                ISAInstrClass.FPU64:       (self.isa_class_p_distr[6]),
                ISAInstrClass.FPUD64:      (self.isa_class_p_distr[6]),
                ISAInstrClass.MEDELEG:     (0),
                ISAInstrClass.TVECFSM:     (0),
                ISAInstrClass.PPFSM:       (0),
                ISAInstrClass.EPCFSM:      (0),
                ISAInstrClass.EXCEPTION:   (0),
                ISAInstrClass.RANDOM_CSR:  (self.isa_class_p_distr[7]),
